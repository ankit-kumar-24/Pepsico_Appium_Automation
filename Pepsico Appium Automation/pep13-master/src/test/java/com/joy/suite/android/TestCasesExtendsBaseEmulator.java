...
class TestCasesExtendsBaseEmulator extends BaseTest {

    private static final String ANDROID_APP = "storage:filename=app-qa-release.aab";
    private static final String ANDROID_DEVICE_NAME = "Google Pixel 4 GoogleAPI Emulator";
   ...
   public Object[][] getDataForSignInTest() {
       return new Object[][] { { "joytest123@gmail.com", "Testing#123@" },
               { "joytest898@gmail.com", "Testing#123@" },
               { "joytest66@gmail.com", "Testing#123@" },
               { "joytest5454@gmail.com", "Testing#123@" }};

   }

    @BeforeSuite
    public void setupDriver() throws MalformedURLException {
        driver =  setUp(ANDROID_APP,ANDROID_DEVICE_NAME, PLATFORMNAME, APPIUM_AUTOMATION_NAME, NEW_COMMAND_TIMEOUT, APPIUM_PLATFORMVERSION);
    }
