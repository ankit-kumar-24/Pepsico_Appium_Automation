...
class TestCasesExtendsBase_Run extends BaseTest {
    private static final String ANDROID_APP = "storage:filename=joy-android-qa-1.0.0+71.apk";
    private static final String ANDROID_DEVICE_NAME = "Samsung_Galaxy_S21_13_real_us";
